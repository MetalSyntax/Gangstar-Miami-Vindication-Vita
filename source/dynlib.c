...
extern void *_Znwj;
// Confirmed missing 2026-09-01 by diffing `objdump -T` UND symbols of the real
// .so against this table: the game hit plt0_stub/reloc_err with
// `Unknown symbol "__aeabi_i2f"`. All of these resolve against the toolchain's
// own libgcc/libstdc++ (same ARM EABI), so registering them is enough.
...
extern long sysconf_soloader(int name);
...
so_default_dynlib default_dynlib[] = {
        ...
        { "__aeabi_memcpy", (uintptr_t)&memcpy_soloader },
        { "__aeabi_memcpy4", (uintptr_t)&memcpy_soloader },
        { "__aeabi_memcpy8", (uintptr_t)&memcpy_soloader },
        ...
        // The .so passes &__dso_handle to __aeabi_atexit from its own global
        // constructors; our loader already has one (from crtbegin.o), and any
        // stable unique address satisfies its "which module is this" role.
        ...
        // Bionic's __isfinitef is newlib's finitef -- same signature, same
        // semantics (non-zero iff the float is neither NaN nor infinite).
        { "__isfinitef", (uintptr_t)&finitef },
        ...
        { "memcpy", (uintptr_t)&memcpy_soloader },
        ...
        { "glBindFramebuffer", (uintptr_t)&glBindFramebufferOES_soloader },
        { "glBindFramebufferOES", (uintptr_t)&glBindFramebufferOES_soloader },
        ...
        { "glCheckFramebufferStatus", (uintptr_t)&glCheckFramebufferStatusOES_soloader },
        { "glCheckFramebufferStatusOES", (uintptr_t)&glCheckFramebufferStatusOES_soloader },
        ...
        { "glColorPointer", (uintptr_t)&glColorPointer_soloader },
        { "glCompileShader", (uintptr_t)&glCompileShader_soloader },
        { "glCompressedTexImage2D", (uintptr_t)&glCompressedTexImage2D_soloader },
        { "glCompressedTexSubImage2D", (uintptr_t)&glCompressedTexSubImage2D_drop },
        ...
        { "glMultiTexCoord4f", (uintptr_t)&glMultiTexCoord4f_soloader },
        ...
        { "glNormalPointer", (uintptr_t)&glNormalPointer_soloader },
        ...
        { "glTexCoordPointer", (uintptr_t)&glTexCoordPointer_soloader },
        ...
        { "glVertexPointer", (uintptr_t)&glVertexPointer_soloader },
